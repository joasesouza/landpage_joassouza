...
const i18n = {
  'pt-BR': {
    ...
    'sobre.p1': 'Engenheiro de software com forte base acadêmica e carreira sólida em times de TI de ambientes complexos, onde colaboração, influência e confiança fazem a diferença. Atualmente atuo como Administrador de Banco de Dados Sênior na Qintess.',
    ...
    'exp.qintess.data': '2025 — atual',
    'exp.qintess.role': 'Administrador de Banco de Dados Sênior',
  ...
  'en': {
    ...
    'sobre.p3': 'I was also a university professor for almost a decade, teaching Administration, Accounting Sciences and Information Systems — and helped the Information Systems program in Olinda become the best among private institutions in Pernambuco (ENADE/MEC 2015).',
